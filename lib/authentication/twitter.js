...
var passport = require('passport'),
    ...
    .Strategy,
    dynamo = require('../core'),
    User = require('../data/mongo/model/twitteruser');
...
dynamo.twitterAuth = function(current) {
    ...
    dynamo.route('get', oauth.base, passport.authenticate('twitter'));

    dynamo.route('get', oauth.callback, passport.authenticate('twitter', {
